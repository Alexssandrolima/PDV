...
namespace CasaMendes.Formularios
{
    public partial class FrmPDV : Form
    {
        ...
        public FrmPDV()
        {
            ...
            //Opromocao = new PromocaoControls();
        ...
        //public PromocaoControls Opromocao;
        ...
        //        if (FrenteDeCaixa.Produto != "" && FrenteDeCaixa.Produto != null)
        //        {
        //            string[] row = { count.ToString("G"), Filtro, FrenteDeCaixa.Produto, this.txtQuantidade.Text, FrenteDeCaixa.Valor.ToString("C2"), FrenteDeCaixa.SubTotal.ToString("C2") };
        ...
        //                FrenteDeCaixa.Produto = Convert.ToString(grid.Rows[i].Cells[2].Value);
        ...
        //{
        //    FrmBuscarClienteViews fc = new FrmBuscarClienteViews
        //    {
        //        Tag = "CaixaAberto"
        //    };
        ...
        private void MenuKeyDown(KeyEventArgs e)
        {
            ...
            //    clsGlobal.TagForm = "";
            //    ffc.ShowDialog();
            //    decimal _Cod = Convert.ToDecimal(ffc.cod);
            //    this.BuscarProduto(_Cod.ToString(""));
            //    ffc.Dispose();
            //}
        ...
        private void FrmPDV_Load(object sender, EventArgs e)
        {
            ...
            //if(Opromocao.Equals(null)) Opromocao = new PromocaoControls();
