...
namespace CasaMendes.Formularios
{
    public partial class frmCarregarVenda : Form
    {
        ...
        public frmCarregarVenda()
        {
            ...
            //this.Text = clsGlobal.MontarTitulo("Tela principal", "Vendas");
        ...
        //{
            ...
            //        PromocaoControls Opromocao = new PromocaoControls(); 
        ...
        private void btnReceber_Click(object sender, EventArgs e)
        {
            ...
            //Cl_PreVenda.Receber(_Codigo.ToString(), clsGlobal.DeStringParadecimal(txtDinheiro.Text.Replace("R$ ", "")), troco);
            //BuscarAnotado();
        }
        ...
        private void dgvClientes_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //    this._Codigo = Convert.ToDecimal(dgvClientes.Rows[e.RowIndex].Cells[0].Value);
            //    this._Cliente = dgvClientes.Rows[e.RowIndex].Cells[1].Value.ToString();
            //    BuscarAnotado();
            //    this.txtParcela.Text = Cl_PreVenda._Parcela.ToString("C2");

            //    if (dgvVendas.Rows.Count == 0 || (dgvVendas.Rows.Count == 0 && Rbt_Fixa.Checked == true))
            //    {
            //        this.txtTotalReceber.Text = "R$ 0.00";
            //        this.txtTotalReceber.Text = "R$ 0.00";
            //        this.txtTotalReceber.Text = "R$ 0.00";
