...
{
    public partial class frmCadProdViews : Form
    {

        #region Variáveis.

        //ProdutoControls oProduto;
        ...
        public frmCadProdViews()
        {
            InitializeComponent();
            //oProduto = new ProdutoControls();
        ...
        private void frmCadastrarProdutos_Shown(object sender, EventArgs e)
        {
            ...
            //        List<pProdutoControls> pL = ProdutoControls.CarregarProduto(this.txtCodigoDeBarras.Text);
