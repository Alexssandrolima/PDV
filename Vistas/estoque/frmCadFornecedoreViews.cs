...
{
    public partial class frmCadFornecedoreViews : Form
    {

        #region Variáveis.

        Classes.FornecedoresControls oFornecedores;

        #endregion

        #region Construtor.

        public frmCadFornecedoreViews(ArrayList arr = null)
        {
            InitializeComponent();
            ...
            //    }
            //    //=================================================================================================
            //    oFornecedores = new Classes.FornecedoresControls();
        ...
        private void btnGravar_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    string sTemp = "";
            //    if (oFornecedores == null) oFornecedores = new Classes.FornecedoresControls();
            //    //============================================================================================
        ...
        private void txtBairro_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            //{
            //    Classes.FornecedoresControls.CarregarComboBox(this.cbEstado);
