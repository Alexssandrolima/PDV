...
{
    public partial class frmFornecedoreViews : Form/*frmBuscarProduto*/
    {
        ...
        //frmCadFornecedoreViews cf;

        public frmFornecedoreViews()
        {
            InitializeComponent();
            //try
            //{
            ...
            //    FornecedoresControls.CarregarDataGridProdutos(this.dgv);
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            //    try
            //    {
            //        cf = new frmCadFornecedoreViews(this.arr);
