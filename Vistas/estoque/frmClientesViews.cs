...
{
    public partial class frmClientesViews : Form
    {
        bool _Fechar = false;
        ArrayList arrCliente = null;

        public frmClientesViews()
        {
            InitializeComponent();
            //===================================================================================================
            ...
            ////cl_Cliente.CarregarDataGridCliente(this.dgv);
        ...
        private void btnNovo_Click(object sender, EventArgs e)
        {
            ...
            frm.ShowDialog();
            frm.Dispose();
            //Classes.cl_Cliente.CarregarDataGridCliente(this.dgv);
        }
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            try
            {
                //cl_Cliente.Excluir(arrCliente[0].ToString());
                //cl_Cliente.CarregarDataGridCliente(this.dgv);
            }
            catch {; }
        }
