    ...
    public partial class FrmEstoque : Form
    {
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (txtCodigoDeBarras.Text != "") { cl_Produto.CarregarDoEstoque(this.dgv, "-1", txtCodigoDeBarras.Text); }
        ...
        private void txtCodigoDeBarras_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.txtCodigoDeBarras.TextLength > 4) {
                    cl_Produto.CarregarDoEstoque(dgv, "-1", txtCodigoDeBarras.Text);
                }
                else { return; }
            }
            catch
        ...
        private void txtBusca_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.txtBusca.TextLength > 0) { cl_Produto.CarregarDoEstoque(dgv, txtBusca.Text, "-1"); }
                else { cl_Produto.CarregarDoEstoque(dgv, "*", "-1"); }
            }
            catch
            {
