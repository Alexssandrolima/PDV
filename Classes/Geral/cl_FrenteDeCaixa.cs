...
namespace CasaMendes.Classes
{
    public class Cl_FrenteDeCaixa : Propriedades.Cl_pFrenteDeCaixa
    {
        ...
        public void BuscarExibirItem(string Filtro = "0")
        {
            try
            {
                string sSql = "SELECT Produto, (PrecoDeVenda * " + Quantidade + ") as SubTotal, PrecoDeVenda as valor FROM tEstoque WHERE CodigoDeBarras = '" + Filtro + "'";
                ...
                {
                    //===============================================================================
                    Produto = Convert.ToString(Linha["Produto"].ToString());
