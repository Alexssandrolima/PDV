...
//void Cl_DadosInicio();
//void AtualizarSqlCeEngine();
//void CriarDb();
//DataSet CarregarDataset(string sSql, string sTabela);
//string RetornoEscalarDeUmRegistro(string sSql);
//string LerUmRegistro(string sSql);
//string LerMaxima(string Tabela, string sPk);
//ArrayList PegarArrayListDados(string sSql);
//ArrayList ListarDados(string sSql, string campo = null, string filto = null);
//DataTable ListarDescontos(string sSql);
//DataTable PegarDados(string sSql, bool b = false);
//DataTable PegarDados(string sSql);
//bool ValidarPosicao(Enumeradores.eIrPara _Acao);
//void Primeiro();
//void Proximo();
//void Ultimo();
//void Voltar();
//void TratarImage(string Path);
//void MontarQuerySql(List<String> Campos, byte b = 1);
//void AdicionarParametro(string Name, Object Value);
//void ExecutarQuery();
//void ExecutarQuery(string _sSql);
//bool ExecutarQuery(bool ComParametro);
//void ExecutarQueryVendas(string _sSql, bool ComParametro);
//void Cadastrar(List<String> Campos, bool condicao);
//void Atualizar(List<String> Campos, bool condicao);
//void CadastrarVendas(List<String> Campos);
//void AtualizarVendas(List<String> Campos, bool S_N);
//void Excluir(string Tabela, string ChavePrimaria, string Filtro = "*");
