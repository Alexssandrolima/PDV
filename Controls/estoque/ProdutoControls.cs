...
{
    public class ProdutoControls : pProdutoControls
    {
        //#region Variáveis
        //DataSet oDs;
        ...
        //public static List<pProdutoControls> CarregarProduto(string Filtro = "-1")
        //{
        //    string sSql = "";
        //    try
        //    {
        ...
        //        if (arr != null)
        //        {
        //            List<pProdutoControls> pL = new List<pProdutoControls>();
        //            pProdutoControls p = new pProdutoControls();
